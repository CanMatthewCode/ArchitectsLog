...
| Platform | Download |
|----------|----------|
| macOS | [Download for Mac](https://github.com/CanMatthewCode/ArchitectsLog/releases/download/v1.0.5/ArchitectsLog-mac.zip) |
| Windows | [Download for PC](https://github.com/CanMatthewCode/ArchitectsLog/releases/download/v1.0.5/ArchitectsLog.exe) |
| Linux | [Download for Linux](https://github.com/CanMatthewCode/ArchitectsLog/releases/download/v1.0.5/ArchitectsLog-Linux) |
